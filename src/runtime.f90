...
CONTAINS
 ...
 PURE SUBROUTINE PM__INTERSECT_SEQ(L1,U1,S1,L2,U2,S2,L3,U3,S3,N3)
    INTEGER(PM__LN),INTENT(IN):: L1,U1,S1,L2,U2,S2
  ...
  SUBROUTINE PM__FILE_SET_VIEW(IFILE,ITYPE,OFFSETS,NOFF,TOTSIZE,IERR,DISP)
    ...
    CALL PM__GET_MPI_DISP_TYPE(ITYPE,OFFSETS,NOFF,CTYPE)
